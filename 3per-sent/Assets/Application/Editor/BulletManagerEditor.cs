...
public class BulletEditor : Editor {
	...
	public override void OnInspectorGUI() {
		...
		obj.tag = TagUtil.BulletTags[EditorGUILayout.Popup ("Bullet Tag",TagUtil.BulletTagsToInt(obj.tag),TagUtil.BulletTags)];
		obj.bulletType = (BulletManager.BulletType)EditorGUILayout.EnumPopup ("Bullet Type", obj.bulletType);
		obj.bulletPrefab = (GameObject)EditorGUILayout.ObjectField( "Bullet Prefab", obj.bulletPrefab, typeof( GameObject ), false );
